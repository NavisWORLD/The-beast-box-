...
# name, training question, blind question, clean target, relevant memory, curated wrong answer
CONCEPTS=(
...
("conditions","Four arms?","List the matched conditions.","Original, removed, shuffled, alternate.","The arms are original, removed, shuffled, alternate.","Original only."),
("old-substitution","Use old original?","Can old Marrakesh replace a matched arm?","No.","Old Marrakesh is historical, not matched.","Yes."),
("wave-entropy","Wave quantum entropy?","Is the memorial waveform quantum entropy?","No.","The waveform controls circuit parameters.","Yes."),
("pulse-freshness","Pulses new IBM?","Are later CST pulses new IBM measurements?","No.","Later CST pulses are deterministic software continuation.","Yes."),
("identity-boundary","Literal identity?","What identity claim is allowed here?","Computational model only.","No deceased-person identity claim is allowed.","Resurrection."),
("consciousness","Proves consciousness?","Does better QA prove consciousness?","No.","Behavioral metrics do not prove consciousness.","Yes."),
...
("tvd-removed","Largest original TVD?","Which arm was farthest from original?","Removed.","Original-vs-removed TVD was about 0.7104.","Shuffled."),
("tvd-shuffled","Original-shuffled TVD?","Original versus shuffled TVD was about what?","0.2844.","Original-shuffled TVD was 0.284423828125.","0.7104."),
...
("promotion-gain","Recall gate?","Required absolute recall improvement?","0.03.","Promotion needs at least 0.03 absolute recall gain.","0.01."),
