...
lint:
	...
	$(PYTHON) -m ruff check beastbox/training scripts/freeze_zeref_genesis.py scripts/build_lexical_corpus.py \
		scripts/build_world_corpus.py scripts/train_zeref_phos_world.py tests/test_training_lineage.py \
		tests/test_training_corpus.py tests/test_quantum_control.py tests/test_zeref_phos_world_runner.py \
		tests/test_zeref_phos_world_cli.py
...
typecheck:
	$(PYTHON) -m mypy beastbox/env_inventory.py beastbox/logging_config.py beastbox/hashutil.py beastbox/aliases.py \
		...
		beastbox/training/quantum_control.py beastbox/training/phos_descendant.py beastbox/training/world_runner.py \
		scripts/train_zeref_phos_world.py scripts/run_architecture_acceptance.py beastbox/cosmic_demo.py
