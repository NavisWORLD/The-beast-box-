...
lint:
	...
	$(PYTHON) -m ruff check beastbox/aliases.py beastbox/hashutil.py beastbox/logging_config.py \
		...
		beastbox/cosmic_web.py beastbox/cosmic_entry.py tests/test_cosmic_web.py
...
typecheck:
	$(PYTHON) -m mypy beastbox/logging_config.py beastbox/hashutil.py beastbox/aliases.py \
		...
		beastbox/product_services.py beastbox/memory.py beastbox/cosmic_web.py beastbox/cosmic_entry.py \
