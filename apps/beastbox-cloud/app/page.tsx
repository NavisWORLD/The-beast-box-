...
export default function Home(){
 ...
 <div className="hero-cta"><Link href="/workspace" className="primary-link">Enter Cosmic Chaos <ArrowUpRight size={19}/></Link><Link href="/try" className="secondary-link">Try RAWRPHØS · Guest <ArrowUpRight size={17}/></Link><a className="secondary-link" href="https://github.com/NavisWORLD/The-beast-box-" rel="noreferrer" target="_blank">Explore the source <ArrowUpRight size={17}/></a></div>
