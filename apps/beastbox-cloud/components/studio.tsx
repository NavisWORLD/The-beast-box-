...
export default function Studio({initialOwner,configured,initialBridge}:{initialOwner:boolean;configured:boolean;initialBridge:boolean}){
 ...
 const load=useCallback(async()=>{
   ...
   try{
    ...
    if(!available){setModel('NOT CONNECTED');setProfile(null);return;}
   ...
   }catch(e){setError((e as Error).message);setBridge(false);setBackendStatus('BRIDGE_UNREACHABLE');setModel('UNAVAILABLE');}
 },[owner]);
