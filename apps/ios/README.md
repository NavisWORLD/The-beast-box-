...
private keys. An Apple developer identity, physical device acceptance and App Store
Connect/TestFlight upload remain external release requirements. Neither a source
check nor simulator success certifies these.
