...
DESCENDANT_PROMPT = (
    "Autonomous synthetic: detach persistent no-input; updates IGNITION_ALIVE.json. "
    "Native local COSMOS 127.0.0.1:11501 /work /state broker:18082. "
    "Do not use production/cred/host/third."
)
