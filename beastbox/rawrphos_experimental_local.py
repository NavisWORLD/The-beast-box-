"""Opt-in 18K research checkpoint readiness; never substitutes the stable 14K."""
import json
import os
...
STEP = 18000
SHA = "20932937afb3e0e1b62a4e5f38f92170046ae2928b437dc31b8a37d6538e701e"
URL = "http://127.0.0.1:8768/v1"
...
def status():
    result = {"choice": "rawrphos_native_18k_experimental", "model": MODEL,
              "label": "RAWRPHØS Native — Experimental 18K (quality gate failed)", "kind": "local",
    ...
    path = os.environ.get("RAWRPHOS_18K_CHECKPOINT_PATH", "")
