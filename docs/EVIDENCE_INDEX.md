...
Pointers into the canonical sealed trees. Do not treat model prose in JSONL as a physics measurement.
...
| Field | Value |
| --- | --- |
| Path | `evidence/final-reality-bridge/` |
| Purpose | Baseline + conversation state snapshots |
| Hardware | historical / not a fresh causal proof |

## How to read a sealed result
